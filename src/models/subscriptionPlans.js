    ...
    return sequelize.define('grant_subscription_plans',
        {
            ...
            admin_seats: { type: Sequelize.INTEGER, allowNull: false, defaultValue: 1 },
            team_seats: { type: Sequelize.INTEGER, allowNull: false, defaultValue: 3 },
        ...
        {
            indexes: [{ unique: true, fields: ['plan_id'] }],
            timestamps: false,
