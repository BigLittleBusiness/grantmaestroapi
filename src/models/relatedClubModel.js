...
export default (sequelize, Sequelize) => {
    return sequelize.define('grant_related_clubs',
        {
            related_club_id: { type: Sequelize.INTEGER(10).UNSIGNED, autoIncrement: true, allowNull: false, primaryKey: true },
