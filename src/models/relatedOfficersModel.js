...
export default (sequelize, Sequelize) => {
    return sequelize.define('grant_related_officers',
        {
            related_officer_id: { type: Sequelize.INTEGER(10).UNSIGNED, autoIncrement: true, allowNull: false, primaryKey: true },
            officer_name: { type: Sequelize.STRING, allowNull: false },
